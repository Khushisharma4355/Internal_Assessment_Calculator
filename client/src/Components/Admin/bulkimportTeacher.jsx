...
import { FiUpload, FiDownload, FiAlertCircle, FiCheckCircle, FiInfo, FiX, FiFile, FiUserCheck, FiMenu, FiXCircle } from 'react-icons/fi';
        ...
        <Container fluid>
          <Row className="mb-4 align-items-center">
            <Col xs={12} md={6}>
              ...
              <p className="text-muted small">Import multiple teachers using an Excel or CSV file</p>
            </Col>
