...
export const ViewAssessment = () => {
  const regno = 20230002; // Hardcoded for now
  ...
  const studentName = data.getStudentAssessment[0]?.student?.student_name;
//   console.log(data.getStudentAssessment[0]?.student?.student_name)
  console.log(data)
  return (
    <div className="mt-4">
