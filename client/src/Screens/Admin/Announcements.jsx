...
// import {
//   createAnnouncement,
//   fetchAnnouncements, // ✅ IMPORTANT: ensure this is exported from your slice
// } from "../../Redux/announcementSlice"; // 🔁 Adjust the path based on your folder structure

// export const AdminAnnouncements = () => {
//   const dispatch = useDispatch();
//   const { announcements, loading } = useSelector((state) => state.announcement);
//   const user = useSelector((state) => state.login.user); // ✅ Assuming 'login' is your reducer
...
//       <h2 className="text-center mb-4 fw-bold">📢 Admin Announcements</h2>
...
//               <span>{ann.title}</span>
//               <Badge bg="info">{ann.type}</Badge>
//             </Card.Title>
//             <Card.Subtitle className="text-muted mb-2">
//               📅 {ann.createdAt || "N/A"}
//             </Card.Subtitle>
//             <Card.Text>{ann.description}</Card.Text>
//             {ann.fileUrl && (
//               <a
//                 href={ann.fileUrl}
//                 download
